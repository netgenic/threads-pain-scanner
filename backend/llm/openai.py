...
class OpenAIProvider(LLMProvider):
    ...
    async def is_available(self) -> bool:
        ...
        try:
            ...
            logger.info(f"OpenAI connected, using model: {self.model}")
            return True
    ...
    async def analyze_posts(
        ...
        """Analyze posts using OpenAI GPT."""
        client = self._get_client()
        ...
        try:
            logger.info(f"Analyzing {len(posts_text)} posts with OpenAI {self.model}")
